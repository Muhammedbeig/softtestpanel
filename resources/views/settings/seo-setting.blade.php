                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group mandatory">
                                                    ...
                                                    <select class="form-control" name="page" data-parsley-required="true">
                                                        ...
                                                        <option value="categories">{{ __('Blog Categories') }}</option>
                                                        <option value="blogs">{{ __('Blog') }}</option>
                                                        <option value="how-search-engines-work">{{ __('How Search Engines Work') }}</option>
                                                        ...
                                                        <option value="software-testing-basics">{{ __('Software Testing Basics') }}</option>
