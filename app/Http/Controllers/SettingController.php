...
class SettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'header_logo' => 'nullable|mimes:jpg,jpeg,png,webp,avif,svg|max:7168',
            'footer_logo' => 'nullable|mimes:jpg,jpeg,png,webp,avif,svg|max:7168',
            'placeholder_image' => 'nullable|mimes:jpg,jpeg,png,webp,avif,svg|max:7168',
            ...
            'default_share_thumbnail' => 'nullable|mimes:jpg,jpeg,png,webp,avif|max:7168',
