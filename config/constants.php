...
return [
    ...
    'DEFAULT_SETTINGS' => [
        ...
        ['name' => 'company_email', 'value' => 'hello@softwaretestingbasics.io', 'type' => 'string'],
        ['name' => 'company_name', 'value' => 'Software Testing Basics', 'type' => 'string'],
        ['name' => 'website_url', 'value' => 'https://softwaretestingbasics.io', 'type' => 'string'],
        ...
        ['name' => 'web_theme_color', 'value' => '#00F4C8', 'type' => 'string'],
        ...
        ['name' => 'mail_from_address', 'value' => 'hello@softwaretestingbasics.io', 'type' => 'string'],
        ['name' => 'depp_link_scheme', 'value' => 'softwaretestingbasics', 'type' => 'string'],
